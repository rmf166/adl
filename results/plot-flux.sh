...
echo '     "numave-p1-10000-DD.dat" using 1:2 title "REF" with lines linetype        1 lc rgb "black"'   >> plot.p
...
echo '     "numedg-p1-10000-DD.dat" using 1:2 title "REF" with lines linetype        1 lc rgb "black"'   >> plot.p
echo 'set key left top' >> plot.p
echo 'set terminal pdfcairo enhanced color dashed' >> plot.p
...
echo '     "numave-p2-10000-DD.dat" using 1:2 title "REF" with lines linetype        1 lc rgb "black"'   >> plot.p
echo 'set key left top' >> plot.p
echo 'set terminal pdfcairo enhanced color dashed' >> plot.p
...
echo 'set yr [0:2]' >> plot.p
echo 'set xr [0:20]' >> plot.p
echo 'plot "numedg-p2-20-LD.dat"    using 1:2 title "LD"  with points pointtype 1 ps 1 lc rgb "red", \'  >> plot.p
echo '     "numedg-p2-20-LC.dat"    using 1:2 title "LC"  with points pointtype 2 ps 1 lc rgb "blue", \' >> plot.p
echo '     "numedg-p2-10000-DD.dat" using 1:2 title "REF" with lines linetype        1 lc rgb "black"'   >> plot.p
echo 'set key left top' >> plot.p
echo 'set terminal pdfcairo enhanced color dashed' >> plot.p
